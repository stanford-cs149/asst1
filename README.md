...
[Thread 1 finished in ]:                [105.916] ms
[Thread 5 finished in ]:                [214.356] ms
...
## Results with the new assignment policy
...
| 16      | 9.73x                                                                                                             |       |
| 30      | 11.55                                                                                                             |       |
| 1200    | 3.5 |   notice that the speedup decreased drastically because of the OS's context switch as I don't have the hardware     |

> notice that the speedup decreased drastically in `1200` threads because of the OS's context switch as I don't have the hardware 

  
## Program 2: Vectorizing Code Using SIMD Intrinsics (20 points) ##

- [X]  Implement a vectorized version of `clampedExpSerial` in `clampedExpVector` . Your implementation 
should work with any combination of input array size (`N`) and vector width (`VECTOR_WIDTH`). 


- [X] Run `./myexp -s 10000` and sweep the vector width from 2, 4, 8, to 16. Record the resulting vector utilization. Does the vector utilization increase, decrease or stay the same as `VECTOR_WIDTH` changes? Why?

> Decrease

> I believe because There is `if`, `else`, `while` and it will statistically have more vector lanes masked

Results of running `./myexp -s 10000` with different vector widths are shown below:
...
Vector Width:              2
Total Vector Instructions: 196840
Vector Utilization:        80.4%
Utilized Vector Lanes:     316606
Total Vector Lanes:        393680
************************ Result Verification *************************
Passed!!!
...
****************** Printing Vector Unit Statistics *******************
Vector Width:              4
Total Vector Instructions: 112068
Vector Utilization:        76.1%
Utilized Vector Lanes:     341150
Total Vector Lanes:        448272
************************ Result Verification *************************
Passed!!!
...
****************** Printing Vector Unit Statistics *******************
Vector Width:              8
Total Vector Instructions: 60378
Vector Utilization:        74.0%
Utilized Vector Lanes:     357212
Total Vector Lanes:        483024
************************ Result Verification *************************
Passed!!!
...
****************** Printing Vector Unit Statistics *******************
Vector Width:              16
Total Vector Instructions: 31343
Vector Utilization:        73.0%
Utilized Vector Lanes:     365867
Total Vector Lanes:        501488
************************ Result Verification *************************
Passed!!!
